...
export const translations = {
  ...
  es: {
    ...
    voteForFunniestCaption: "¡Vota por el Título Más Gracioso!",
    whichStatementAIWrote: "¿Qué declaración crees que escribió la IA?",
    voted: "¡Votado!",
    yourCaption: "Tu Título",
    yourStatement: "Tu Declaración",
    roomNotFound: "Sala no encontrada. Verifica tu código e intenta de nuevo.",
    ...
    whoWroteThis: "¿Quién Escribió Esto?",
    captionCascade: "Cascada de Títulos",
    twoTruthsBot: "Dos Verdades y un Bot",
    instantTrivia: "Trivia Instantánea",
  ...
  fr: {
    ...
    voteForBestAnswer: "Votez pour la Meilleure Réponse!",
    voteForThis: "Voter pour Ceci",
    voteForFunniestCaption: "Votez pour la Légende la Plus Drôle!",
    whichStatementAIWrote: "Quelle déclaration pensez-vous que l'IA a écrite?",
    voted: "Voté!",
    yourCaption: "Votre Légende",
    yourStatement: "Votre Déclaration",
    roomNotFound: "Salle introuvable. Vérifiez votre code et réessayez.",
    partyEnded: "Cette fête est terminée, mais vous pouvez en créer une nouvelle!",
    startNewParty: "Créer une Nouvelle Fête",
    ...
    whoWroteThis: "Qui a Écrit Ça?",
    captionCascade: "Cascade de Légendes",
    twoTruthsBot: "Deux Vérités et un Bot",
    instantTrivia: "Trivia Instantané",
    whoWroteThisDesc: "Repérez la réponse générée par IA parmi les vraies",
  ...
  pt: {
    ...
    voteForFunniestCaption: "Vote na Legenda Mais Engraçada!",
    whichStatementAIWrote: "Qual declaração você acha que a IA escreveu?",
    voted: "Votado!",
    yourCaption: "Sua Legenda",
    yourStatement: "Sua Declaração",
    roomNotFound: "Sala não encontrada. Verifique seu código e tente novamente.",
    partyEnded: "Esta festa terminou, mas você pode começar uma nova!",
    startNewParty: "Começar uma Nova Festa",
    ...
    instantTrivia: "Trivia Instantânea",
